...
import { FaDownload, FaUpload, FaFileExcel, FaCheckCircle, FaExclamationCircle, FaInfoCircle, FaFileExport, FaFilter, FaCalendarAlt, FaSpinner, FaTimes, FaExclamationTriangle } from 'react-icons/fa';
...
const ImportarExcelPage = () => {
    ...
    useEffect(() => {
        const loadFacultadesForExport = async () => {
            if (filtrosExport.sedeId) {
                const data = await importService.getFacultades(filtrosExport.sedeId);
    ...
    useEffect(() => {
        const loadProgramasForExport = async () => {
            if (filtrosExport.facultadId) {
                const data = await importService.getProgramas(filtrosExport.facultadId);
    ...
    const loadCatalogs = async () => {
        try {
            ...
            setPageError('Error al cargar catálogos: ' + (error.message || 'Verifique la conexión del backend.'));
        }
    };
    ...
    const loadFacultades = async (sedeId) => {
        try {
            ...
            setPageError('Error al cargar facultades: ' + (error.message || 'Verifique la conexión del backend.'));
        }
    };
    ...
    const loadProgramas = async (facultadId) => {
        try {
            ...
            setPageError('Error al cargar programas: ' + (error.message || 'Verifique la conexión del backend.'));
        }
    };
    ...
    const handleDescargarPlantilla = async () => {
        ...
        try {
            ...
            setImportResults({
                ...
                fallidos: 0,
                totalRegistros: 0,
                mensaje: error.message || 'Error al descargar la plantilla.',
    ...
    const handleExportarDatos = async () => {
        ...
        try {
            ...
            setError('Error al exportar los datos: ' + (error.message || 'Intenta de nuevo.'));
        } finally {
        ...
        <div className="page-container">
            ...
            <div className="page-header">
                <div className="header-title">
                    ...
                    <div>
                        ...
                        <p>Gestiona la importación y exportación de datos de participantes.</p>
                    </div>
                </div>
            ...
            {pageError && (
                <div className="alert alert-danger">
                    ...
                    <button onClick={() => setPageError('')} className="alert-close">×</button>
                </div>
            )}

            {/* Alertas de éxito/error de importación/exportación */}
            {importResults && (
            ...
            <div className="card">
                ...
                <div className="modal-body"> {/* Usamos modal-body para el padding */}
                    ...
                    <div className="filtros-section">
                        ...
                        <div className="filtros-grid">
                            ...
                            <div className="form-group">
                                <label className="form-label"><FaCalendarAlt /> Periodo *</label>
                                <select
                                    name="periodoId"
